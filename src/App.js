...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://todolist-8eeb9-default-rtdb.europe-west1.firebasedatabase.app/books.json')
  ...
  const deleteTodo = (id) => {
    fetch(`https://todolist-8eeb9-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
   {
      method: 'DELETE',
    })
    .then(response => fetchItems())
